...
med_model = joblib.load('models/medication_model.pkl')
dosage_model = joblib.load('models/dosage_model.pkl')
duration_model = joblib.load('models/duration_model.pkl')
effectiveness_model = joblib.load('models/effectiveness_model.pkl')
reactions_model = joblib.load('models/reactions_model.pkl')
